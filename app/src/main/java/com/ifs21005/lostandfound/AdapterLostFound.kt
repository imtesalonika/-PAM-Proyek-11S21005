...
class AdapterLostFound (private val dataset : MutableList<LostFoundXX>, val context: Context?, val apiService : Api, val authToken : String, val currentUserName : String, val aksesDatabase : DataViewModel) : RecyclerView.Adapter<AdapterLostFound.ViewHolder>()  {
