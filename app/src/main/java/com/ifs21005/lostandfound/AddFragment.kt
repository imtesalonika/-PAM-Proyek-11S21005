                        ...
                        call2.enqueue(object : Callback<UploadCoverResponse> {
                            override fun onResponse(
                                ...
                                if (p1.isSuccessful) {
                                    ...
                                    val bottom = activity!!.findViewById<BottomNavigationView>(R.id.bar_bawah)
                                    bottom.selectedItemId = R.id.beranda
//                                    navigateToFragment(HomeFragment())
    ...
    private fun navigateToFragment(fragment: Fragment) {
        ...
        transaction.replace(R.id.tempat_fragment, fragment)
